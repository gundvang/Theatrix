...
/*
 | ------------------------------------------------------------
 | Check for swipe interaction
 | ------------------------------------------------------------
 | This function is called on swipe
 | and checks in which direction is swiped.
	...
	$('[data-link]').on('click', function(event) {
		...
		if ($(this).data('link') && $( '#'+$(this).data('link') ).length) {
			if ($(this).data('direction')) {
				Theatrix.data.direction = $(this).data('direction');
				console.log( Theatrix.data.direction );
			} else {
